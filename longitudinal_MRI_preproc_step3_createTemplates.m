%% INCA Lab SPREAD Preproc Step 3: template creation
...
shoot_templatePath = [study_path, filesep, study_name, '_shoot_template'];
if ~exist(shoot_templatePath, 'dir')
    mkdir(shoot_templatePath);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% parse user inputs
pars = inputParser;
